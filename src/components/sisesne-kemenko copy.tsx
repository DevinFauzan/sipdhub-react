...
const SisenseKemenkoOneTheme: React.FC<{ isSelected: boolean }> = ({ isSelected }) => {
      ...
      widgets: [
        {
          ...
          widget: {
            ...
            iconWrapperClass: 'bg-orange-200',
...

        {
          ...
          widgetType: 'default',
          widget: {
            id: '67592351d5db91003325c509', title: 'Anggaran Kemiskinan Ekstrim Nasional',
        ...
        },
        {
          ...
          widgetType: 'default',
          widget: {
            id: '67592355d5db91003325c50b', title: 'Anggaran Kemiskinan Ekstrim Provinsi',
            styleOptions: customStyle12,
            titleWrapperClass: 'bg-teal-100',
            widgetContentWrapperClass: 'bg-teal-50',
            titleStyle: { paddingTop: '0.3rem', paddingBottom: '1rem' },
        ...
        },
        {
          ...
          widgetType: 'default',
          widget: {
            id: '67592358d5db91003325c50d', title: 'Anggaran Kemiskinan Ekstrim Kabupaten',
            styleOptions: customStyle12,
            titleWrapperClass: 'bg-teal-100',
            widgetContentWrapperClass: 'bg-teal-50',
            titleStyle: { paddingTop: '0.3rem', paddingBottom: '1rem' },
        ...
        },
        {
          ...
          widgetType: 'default',
          widget: {
            id: '67592422d5db91003325c519', title: 'Anggaran SPM Kemiskinan Ekstrim Nasional',
            styleOptions: customStyle12,
            titleWrapperClass: 'bg-teal-100',
            widgetContentWrapperClass: 'bg-teal-50',
            titleStyle: { paddingTop: '0.3rem', paddingBottom: '1rem' },
        ...
        },
        {
          ...
          widgetType: 'default',
          widget: {
            id: '67592424d5db91003325c51b', title: 'Anggaran SPM Kemiskinan Ekstrim Provinsi',
            styleOptions: customStyle12,
            titleWrapperClass: 'bg-teal-100',
            widgetContentWrapperClass: 'bg-teal-50',
            titleStyle: { paddingTop: '0.3rem', paddingBottom: '1rem' },
        ...
        },
        {
          ...
          widgetType: 'default',
          widget: {
            id: '67592428d5db91003325c51d', title: 'Anggaran SPM Kemiskinan Ekstrim Kabupaten',
            styleOptions: customStyle12,
            titleWrapperClass: 'bg-teal-100',
            widgetContentWrapperClass: 'bg-teal-50',
            titleStyle: { paddingTop: '0.3rem', paddingBottom: '1rem' },
        ...
        // 2
        {
          ...
          widgetType: 'default',
          widget: {
            id: '675f029ad5db91003325cb3f', title: 'Alokasi Anggaran Kemiskinan Ekstrim Berdasarkan Program Pemerintah',
            styleOptions: customStyle6,
            titleWrapperClass: 'bg-teal-100',
            widgetContentWrapperClass: 'bg-teal-50',
            titleStyle: { paddingTop: '0.3rem', paddingBottom: '1rem' },
        ...
        // 3
        {
          ...
          widgetType: 'default',
          widget: {
            id: '67595260d5db91003325c5d2', title: 'Alokasi Anggaran Kemiskinan Ekstrim Berdasarkan Kegiatan Pemerintah',
            styleOptions: customStyle6,
            titleWrapperClass: 'bg-teal-100',
            widgetContentWrapperClass: 'bg-teal-50',
            titleStyle: { paddingTop: '0.3rem', paddingBottom: '1rem' },
        ...
        // 4 
        {
          ...
          widgetType: 'default',
          widget: {
            id: '675952bbd5db91003325c5d6', title: 'Alokasi Anggaran Kemiskinan Ekstrim Berdasarkan Sub Kegiatan Pemerintah',
            styleOptions: customStyle6,
            titleWrapperClass: 'bg-teal-100',
            widgetContentWrapperClass: 'bg-teal-50',
            titleStyle: { paddingTop: '0.3rem', paddingBottom: '1rem' },
        ...
        // 5
        {
          ...
          widgetType: 'default',
          widget: {
            id: '675f035ad5db91003325cb49', title: 'Alokasi Anggaran Kemiskinan Ekstrim Berdasarkan SKPD Pemerintah',
            styleOptions: customStyle6,
            titleWrapperClass: 'bg-teal-100',
            widgetContentWrapperClass: 'bg-teal-50',
            titleStyle: { paddingTop: '0.3rem', paddingBottom: '1rem' },
        ...
        //   widgetType: 'default',
        //   widget: {
        //     id: '675f037bd5db91003325cb4d', title: 'Alokasi Anggaran Kemiskinan Ekstrim Berdasarkan Sub-SKPD Pemerintah',
        //     styleOptions: customStyle6,
        //     titleWrapperClass: 'bg-teal-100',
        //     widgetContentWrapperClass: 'bg-teal-50',
        //     titleStyle: { paddingTop: '0.3rem', paddingBottom: '1rem' },
...
export default SisenseKemenkoOneTheme;
